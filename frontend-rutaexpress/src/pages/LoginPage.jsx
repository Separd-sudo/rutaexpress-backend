      ...
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div className="card" style={{ boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.08), 0 2px 4px -2px rgba(0, 0, 0, 0.04)' }}>
          ...
          >
            ...
            <span>{isLoggingIn ? 'Conectando con Azure...' : 'Iniciar sesion con Microsoft'}</span>
          </button>

          {!isAzureConfigured() && (
            <div style={{ marginTop: '0.75rem', fontSize: '0.75rem', color: '#64748b', textAlign: 'center' }}>
              * Azure AD opera en modo simulado para desarrollo local (configure VITE_AZURE_CLIENT_ID para tenant corporativo).
            </div>
          )}
